  ...
  const doc = {
    ...
    content:[
      {table:{widths:["*","auto"],body:[[
        {stack:[{text:"RÉSERVATION",fontSize:15,bold:true,color:C.white},{text:`N° ${d.num}  ·  ${d.date}`,fontSize:8.5,color:C.primaryMid,marginTop:3}],fillColor:C.primary,border:[false,false,false,false],margin:[14,11,0,11]},
        {stack:[{text:d.co.name,bold:true,fontSize:9,color:C.white,alignment:"right"},{text:d.co.phone,fontSize:8,color:C.primaryMid,alignment:"right",marginTop:2},{text:`Date RDV : ${d.date}`,fontSize:7.5,color:"#A5B4FC",alignment:"right",marginTop:3}],fillColor:C.primary,border:[false,false,false,false],margin:[0,11,14,11]},
